...
# BEGIN QUERY 
CREATE OR REPLACE TABLE `mex-fisheries.mex_vms.mex_vms_processed_v_20250613` # <---------------- TABLE NAME NEEDS TO BE MANUALLY UPDATED
AS
WITH all_data AS (
  SELECT
  DISTINCT
...
FROM
  `mex-fisheries.mex_vms.mex_vms_v_20250613`
